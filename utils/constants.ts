...
export const deliverWithPowerKingDescText = "Our convenient delivery service brings the products right to your chosen destination.";
...
export const downloadAppText = "Download the app to delivery anywhere, any time";
...
export const changePasswordDescText = "Please enter your new password to update your account security"
export const businessProfileDescText = "A business profile effectively showcases your brand identity, mission, and unique offerings to potential clients"
export const resetPasswordDescText = "Reset your password and regain access to your account securely."
...
export const businessRegistrationCertificateText = "Business Registration Certificate"
export const companyInfoTextDesc = "Please enter your company details to help us understand your business better."
...
export const forgetPasswordDesc = "Enter your email address to receive instructions for resetting your password."
...
export const completeOwnerInfoDescText = "Please provide the complete owner information to ensure accurate account setup and communication."


//reset password

export const passwordHasBeenResetText = "Password has been reset"
export const passwordHasBeenResetDescText = "Your password has been reset successfully. Please login to your account."
...
export const searchingForDriversDescText = "We will help match drivers until 15 minutes before the pick-up time."
export const stopsDescText = "The route displayed is an estimated route and may not reflect the actual route due to factors such as traffic jams or other unforeseen circumstances."
export const viewDetailsText = "View details"
export const myOrdersText = "My Orders"
export const driverText = "Driver"
export const checkQuotationAndConfirmOrderText = "Check quotation and confirm order"
...
export const cancelDescText = " Are you sure you want to cancel the order? You can cancel it before the vehicle arrive."
export const specifyReasonText = "Please specify your reason for canceling the order."
export const availableVoucherText = "Available Voucher"
export const applyText = "Apply"
export const amountDescText = " The total fee is subject to change if other tunnels, bridges, parking and extra services are used."
